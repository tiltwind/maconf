...
## download:
```
# make sure the version of glibc of your linux
ldd --version

# linux
curl -C - -O https://cdn.mysql.com//Downloads/MySQL-8.0/mysql-8.0.42-linux-glibc2.28-x86_64.tar.xz
...
2017-10-01T07:43:28.203532Z 1 [Note] A temporary password is generated for root@localhost:  XawBSu0OGR<=
➜  mysql
```
...
CREATE USER 'test'@'localhost' IDENTIFIED BY 'p0ssw0rd';
GRANT ALL PRIVILEGES ON test.* to 'test'@'localhost';

CREATE USER 'test'@'%' IDENTIFIED BY 'p0ssw0rd';
